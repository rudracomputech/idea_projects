...
class _EcommerceShopLayoutState extends ConsumerState<EcommerceShopLayout> {
                ...
                data: (shopDetails) {
                  ...
                  return Column(
                    children: [
                      ...
                      Expanded(child: _buildTabBarViewWidget(context)),
                    ],
                  );
                },
  ...
  Widget _buildHeaderWidget(BuildContext context, ShopDetails shopDetails) {
    return AnimatedContainer(
      ...
      child: Column(
        children: [
          if (isHeadingShow) _buildShopInfoCard(context, shopDetails),
          if (shopDetails.banners.isNotEmpty && isHeadingShow)
            _buildBannerWidget(shopDetails),
          _buildFilterRowWidget(context),
        ],
      ),
    );
  }
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Gap(2.h),
              Text(
                "${shopDetails.totalProducts}+ ${S.of(context).Products}",
  ...
  final List<String> filterText = ['All Products', 'Categories'];
