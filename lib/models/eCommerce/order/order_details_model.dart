...
class Order {
  ...
  late final dynamic totalAmount;
  late final dynamic discount;
  late final dynamic couponDiscount;
  late final dynamic payableAmount;
  late final dynamic quantity;
  late final dynamic deliveryCharge;
...
class Shop {
  ...
  late final dynamic totalProducts;
  late final dynamic totalCategories;
...
class Products {
  ...
  late final dynamic orderQty;
  late final String? color;
  late final String? size;
  late final dynamic discountPrice;
  late final dynamic rating;
